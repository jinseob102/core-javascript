...
// ? ladder.up().up().up().showSetp() 으로 하고 싶다. 어떻게 해야할까?
// ! 각 함수에 return this; 를 통해서 ladder를 내보내면 된다!!
...
//     //todo 오늘 연구해볼 대상!!!!!!!!!!!!
//     return this.menu.reduce((acc,cur) => acc + cur.price * cur.count,0) //todo 오늘 연구해볼 대상!!!!!!!!!!!!
//   }
// };
